...
import { TEACHER_PASSWORD } from "../../config/teacher";
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setTimeout(() => {
      if (password === TEACHER_PASSWORD) {
        ...
        localStorage.setItem("amr.teacher.auth", "true");
        // Redirect to teacher print page
        window.location.href = "/act-math-review/teacher";
      } else {
      ...
      <div className="flex-1 flex items-center justify-center px-4">
        <div className="bg-slate-800 rounded-2xl border border-slate-700 p-8 max-w-md w-full shadow-xl">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-400">Worksheet Printing Access</p>
          </div>
          
          <p className="text-slate-300 mb-6 text-center">
            Please enter the teacher password to access worksheet printing features.
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed transition"
              >
